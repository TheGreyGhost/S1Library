...
/**
 * An implementation of ShaplessRecipes that also gives a player to check.
 */
public abstract class PlayerBasedShaplessRecipe extends ShapelessRecipes //TODO verify still working.
{
